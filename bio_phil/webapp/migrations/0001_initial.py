# Generated by Django 2.0.5 on 2018-10-30 18:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_summary', models.CharField(default=models.CharField(max_length=100), max_length=300)),
        ...
        migrations.AddField(
            model_name='module',
            name='module_image',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='webapp.ModuleImage'),
        ),
        migrations.AddField(
            model_name='download',
            name='module',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='webapp.Module'),
        ),
        migrations.AddField(
            model_name='user',
            name='access_object',
